...
_SEVERITY_BY_CODE: dict[str, Severity] = {
    ...
    "NO_PRIOR_MATCH": "warn",
    "NO_PRIOR_MONTH_MATCH": "warn",
    "WRITEBACK_MISSING_DESCRIPTION": "warn",
    "WRITEBACK_NO_WORKBOOK_MATCH": "warn",
...
_CATEGORY_BY_CODE: dict[str, str] = {
    ...
    "NO_PRIOR_MATCH": "data_validation",
    "NO_PRIOR_MONTH_MATCH": "data_validation",
    "WRITEBACK_MISSING_DESCRIPTION": "data_validation",
    "WRITEBACK_NO_WORKBOOK_MATCH": "data_validation",
