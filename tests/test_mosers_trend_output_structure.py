"""Tests for the Trend MOSERS output structure contract."""
...
from counter_risk.mosers.workbook_generation import (
    ...
    get_mosers_trend_transformation_scope,
)
from counter_risk.parsers.nisa_trend import parse_nisa_trend


def test_trend_output_structure_defines_expected_cprs_layout() -> None:
...
def test_trend_transformation_scope_defines_core_mappings() -> None:
    scope = get_mosers_trend_transformation_scope()
...
def test_trend_fixture_generates_using_documented_layout_contract() -> None:
